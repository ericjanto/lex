...
class VocabManager:
    ...
    def add_to_anki(self, lemma: str) -> bool:
        ...
        # Note: get_lemma_contexts was not in apirequestor.py in the restore, 
        # so this might fail if run. It might have been removed or I missed it in git history.
        # But for 'recovery' purposes I will leave it as is.
        try:
            ...
            context_text = (
             ...
             context_text = "Context retrieval not implemented in legacy API requestor."

        result = self.anki.add_note(lemma, context_text)
        # Check if result is a dict and has 'error'
